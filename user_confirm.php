...
<div class="min-h-screen w-5/6 flex flex-col items-center bg-[#F1F6F5] rounded-lg p-4">
  ...
  <form action="user_submit.php" method="post" class="w-full flex flex-col justify-center sm:items-center m-2">
    ...
    <input type="hidden" name="username" value="<?= h($_POST['username']); ?>">
    <input type="hidden" name="email" value="<?= h($_POST['email']); ?>">
    <input type="hidden" name="password" value="<?= h($_POST['password']); ?>">
    <input type="hidden" name="pass_confirm" value="<?= h($_POST['pass_confirm']); ?>">
    <input type="hidden" name="user_type" value="<?= h($_POST['user_type']); ?>">
    <input type="hidden" name="admin_password" value="<?= h($_POST['admin_password']); ?>">
